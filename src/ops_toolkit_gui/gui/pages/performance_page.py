...
from ops_toolkit_gui.core.models.performance import CpuCoreUsage, PerformanceData, ProcessStat
...
class PerformancePage(QWidget):
    def __init__(self) -> None:
        ...
        layout.addWidget(self.cpu_cores[0])
        layout.addWidget(self.processes[0])
        layout.addStretch(1)
