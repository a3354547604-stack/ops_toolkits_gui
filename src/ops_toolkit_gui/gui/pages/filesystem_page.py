...
from ops_toolkit_gui.models.filesystem import DirUsage, FilesystemData, LargeFile, MountUsage, PermCheck
...
class FilesystemPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        layout.addWidget(self._mounts[0], 2)
        layout.addWidget(self._large[0], 1)
        layout.addWidget(self._dirs[0], 1)
        layout.addWidget(self._perms[0], 2)
